...
import organic_vegitable_image from "./organic_vegitable_image.webp";
import fresh_fruits_image from "./fresh_fruits_image.webp";
import bottles_image from "./bottles_image.webp";
import maggi_image from "./maggi_image.webp";
import dairy_product_image from "./dairy_product_image.webp";
import bakery_image from "./bakery_image.webp";
...
// url    — the full Cloudinary URL from your database
// width  — the display width in pixels you need
export const getOptimizedImageUrl = (url, width = 300) => {
  // Guard: return original if not a Cloudinary URL
  if (!url || !url.includes('res.cloudinary.com')) return url

  // Insert transformation parameters between /upload/ and the rest
  return url.replace('/upload/', `/upload/w_${width},f_webp,q_auto,c_fill/`)
}